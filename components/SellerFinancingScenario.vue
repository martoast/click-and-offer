      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div class="space-y-4">
          ...
          <div class="input-group">
            ...
            <p
              v-if="!reapi_property?.mls_active"
              class="input-help"
            >
              Default: Estimated Value ({{ formatPrice(reapi_property?.estimatedValue) }})
              + 10%
            </p>
          </div>
          <div class="input-group">
        ...
        >
          ...
          >
            ...
            <div class="p-4 relative">
              ...
              <div class="text-lg font-bold text-white mt-1">
                {{ formatPrice(sellerFinancingCalculated.monthlyTaxInsurance) }}/mo
              </div>
            </div>
