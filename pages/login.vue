<template>
    <div class="min-h-screen bg-black flex flex-col items-center justify-center relative overflow-hidden">
      <!-- Background gradient -->
      <div class="absolute inset-0 bg-gradient-radial from-yellow-gold/5 via-gray-900/30 to-black/90"></div>
      ...
      <div class="relative z-10 w-full max-w-6xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <p class="text-lg text-gray-300 mb-8 max-w-lg">
            Your all-in-one platform for analyzing properties, generating offers, and closing deals with confidence.
          </p>
          ...
          >
            ...
            <span class="absolute inset-0 bg-gradient-to-r from-yellow-gold-light to-yellow-gold opacity-0 group-hover:opacity-30 transition-opacity duration-300"></span>
          </button>
