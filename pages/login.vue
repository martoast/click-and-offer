<template>
  <div class="min-h-screen bg-black relative overflow-hidden">
    ...
    <div class="relative z-10 w-full">
      ...
      <!-- Full Width Demo Video Section -->
      <div class="relative py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
          <!-- Section Header -->
          <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">
              See <span class="text-yellow-gold">Click&Offer</span> in Action
            </h2>
            <p class="text-lg text-gray-300 max-w-2xl mx-auto">
              Watch our detailed demo to discover how Click&Offer streamlines your property analysis and offer generation process
            </p>
          </div>

          <!-- Demo Video Container -->
          <div class="relative rounded-xl overflow-hidden shadow-2xl border border-yellow-gold/20 bg-gray-900 max-w-5xl mx-auto">
            <!-- Video Overlay with Watch Demo Button -->
            <div class="relative w-full" style="padding-bottom: 56.25%;">
              <div 
                v-if="!demoVideoClicked" 
                @click="handleDemoVideoClick"
                class="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center cursor-pointer z-10 transition-all duration-300 hover:bg-black/50"
              >
                <div class="text-center space-y-4">
                  <!-- Watch Demo Button -->
                  <button class="bg-gradient-to-r from-yellow-600 to-yellow-gold px-8 py-4 rounded-lg font-bold text-black hover:from-yellow-gold hover:to-yellow-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-yellow-gold/20 transform hover:-translate-y-0.5 text-lg">
                    Watch Full Demo
                  </button>
                  <p class="text-white/80 text-sm mt-2">Click to play</p>
                </div>
              </div>
              
              <iframe
                src="https://drive.google.com/file/d/1a_o23wTjKfGoDX7tI3GrLgmYs6-YjSJr/preview"
                frameborder="0"
                width="100%"
                height="100%"
                allowfullscreen
...
const demoVideoClicked = ref(false);
